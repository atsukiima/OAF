 ...
 * @author Chris O
 */
public class SCTAggregatedPAreasList extends AbstractEntityList<AggregatedNodeEntry<Concept, SCTPArea, SCTAggregatePArea>> {
    ...
    @Override
    protected String getBorderText(Optional<ArrayList<AggregatedNodeEntry<Concept, SCTPArea, SCTAggregatePArea>>> entities) {
